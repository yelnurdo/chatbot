...
# Phrases
START_PHRASE = 'Здравствуйте! Я Psychology-бот. Напишите свой вопрос, а я постараюсь ответить на него.'
...
# g4f
MAX_TOKENS = 3072 - 100 - 100
MAX_MESSAGES = 10

START_PROMPT = (
    {
        'role': 'user',
        'content': 'Отвечай только на русском, даже если я пишу на другом языке, если не попрошу ответ на другом языке, также выполняй работу психолога',
        'tokens': 60
    },
    {
        'role': 'assistant',
        'content': 'Конечно, я буду отвечать только на русском языке, если вы не попросите ответить на другом языке, а также буду выполнять роль психолога.',
        'tokens': 60
    }
)
